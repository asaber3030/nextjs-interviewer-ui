...
import { SearchParams, build } from "search-params"
...
export const PaginatePrevious = ({ searchParams, className, disabled }: Props) => {
  ...
  return (
    <Button variant="outline" className={cn(className, "bg-white")} disabled={disabled || page < 2} onClick={() => router.push(`?${finalURL}`)}>
